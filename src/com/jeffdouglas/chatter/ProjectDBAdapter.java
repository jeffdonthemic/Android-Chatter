...
public class ProjectDBAdapter {
    ...
    private static final String DATABASE_TABLE = "projectUpdates";
    ...
    private static final String DATABASE_CREATE =
        "create table projectUpdates (_id integer primary key autoincrement, "
        + "id text not null, feedid text not null, title text, body text not null, createdDate date not null);";
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase db) {
        	Log.i("---- jeff ----", "creating project database");
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            ...
            db.execSQL("DROP TABLE IF EXISTS projectUpdates");
            onCreate(db);
        }
    }
     ...
     */
    public long createProjectUpdate(String title, String body, String id, String feedid, Date createdDate) {
    ...
    public Cursor fetchAllUpdates() {
        return mDb.query(DATABASE_TABLE, new String[] {KEY_ROWID, KEY_TITLE,
                KEY_BODY, KEY_ID, KEY_FEEDID, KEY_CREATEDDATE}, null, null, null, null,  KEY_CREATEDDATE + " asc");
    }
     ...
     */
    public Cursor fetchProjectUpdate(long rowId) throws SQLException {

        Cursor mCursor = mDb.query(true, DATABASE_TABLE, new String[] {KEY_ROWID,
        		KEY_TITLE, KEY_BODY, KEY_ID, KEY_FEEDID, KEY_CREATEDDATE}, 
